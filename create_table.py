...
sqls = [ 
   ...
   "create table Posts (id integer primary key, userid varchar(64) not null, content varchar(1024) not null, photo varchar(128) not null, time datetime not null default current_timestamp);",
