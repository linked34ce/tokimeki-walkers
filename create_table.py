...
sqls = [ 
   ...
   "create table Visits (user_id int not null, location_id int not null, photo varchar(100) unique, isit_count int not null default 0, last_visit datettime not null default current_timestamp, primary key(user_id, location_id));"]
