...
sqls = [
    ...
    "insert into Locations (id, name, latitude, longitude, summary, scene, image) values (1002, '宮治研究室', 35.5662249, 139.4023064, '「相模原キャンパスO棟」に位置している', 'そんなものはない', '/static/tmp/no_image.jpg');"
]
