...
sqls = [
    ...
    "insert into Locations (id, name, latitude, longitude, summary, scene, image) values (3, '東京テレポート駅ゲート (ダイバーシティ 東京プラザ)', 35.62595157098818, 139.77626504706365, '「ダイバーシティ 東京プラザ」は、「東京テレポート駅」の近くにある商業施設であり……', 'TVアニメ1期のOPでは、せつ菜が……', '/static/images/op_setsuna.jpg');",
    "insert into Locations (id, name, latitude, longitude, summary, scene, image) values (4, '', , , '', '', '/static/images/');",
