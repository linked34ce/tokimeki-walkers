...
sqls = [
    ...
    "insert into Locations (id, name, latitude, longitude, summary, scene, image) values (5, '旧パレットタウン 東京テレポート駅側入口', 35.62625254211352, 139.78058600919852, '', '', 'season1_opening_scene05.jpg');",
    ...
    "insert into Locations (id, name, latitude, longitude, summary, scene, image) values (17, 'アクアシティお台場 グリエン・パサージュ', 35.628345593759455, 139.77419416917553, '', '', 'season2_opening_scene10.jpg');",
    "insert into Locations (id, name, latitude, longitude, summary, scene, image) values (18, 'シーリアお台場 三番街 5号棟', 35.63045481906742, 139.77923867586776, '', '', 'season2_opening_scene11.jpg');",
    ...
    "insert into Locations (id, name, latitude, longitude, summary, scene, image) values (31, '都営バス 東雲一丁目 東京ビッグサイト方面', 35.64677018983122, 139.8016213410817, '', '', 'season1_episode11_scene01.jpg');",
